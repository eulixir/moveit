        ...
        <div className={styles.PrivacyContainer}>
          <div className={styles.ContentContainer}>
            ...
            <p className={styles.TextContent}>
              ...
              <p>
                A sua privacidade é importante para nós. É política do move.it
                respeitar a sua privacidade em relação a qualquer informação sua
                que possamos coletar no site{' '}
                <a href="https://moveit-joaopealves.vercel.app">move.it</a>, e
              ...
              <h2>Política de Cookies moveit</h2>
              ...
              <ul>
                ...
                <li>
                  ...
                  pagamento e alguns cookies são essenciais para garantir que
                  seu pedido seja lembrado entre as páginas, para que possamos
                ...
                <li>
                  ...
                  <br />
                  <br />
                  Para proporcionar uma ótima experiência neste site, fornecemos
                  a funcionalidade para definir suas preferências de como esse
                  site é executado quando você o usa. Para lembrar suas
              ...
              <ul>
                <li>
                  ...
                  análise mais difundidas e confiáveis ​​da Web, para nos ajudar
                  a entender como você usa o site e como podemos melhorar sua
              ...
              <p>
                ...
                informação que o moveit oferece no site e com caráter
              ...
              <ul>
                ...
                <li>
                  ...
                  xenofóbica, ou <a href="https://salmao.pt/">salmao</a>,
                  apostas desportivas (ex.: Betway), jogos de sorte e azar,
                  qualquer tipo de pornografia ilegal, de apologia ao terrorismo
                  ou contra os direitos humanos;
                </li>
                <li>
                  C) Não causar danos aos sistemas físicos (hardwares) e lógicos
                  (softwares) do moveit, de seus fornecedores ou terceiros, para
              ...
              <p>
                Esta política é efetiva a partir de <strong>March</strong>/
                <strong>2021</strong>.
              </p>
            </p>
          </div>
